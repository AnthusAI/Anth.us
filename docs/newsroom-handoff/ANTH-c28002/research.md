...
Ryan, 2026-09-01: Monitor community bar is not aiuse/aiquota. Those are tiny. Follow **CodexBar** (live leftover, ~21k★) and **ccusage** (historical spend from logs, ~18k★ / 85k npm/wk). Also OpenUsage desktop and tokscale. See `quota-community.md`.
