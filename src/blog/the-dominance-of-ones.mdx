...
<BlogImage images={props.pageContext.frontmatter.images} index={20} className="right" alt="The distribution of lead digits in natural numbers according to Benford's Law." />Want to see something weird about numbers?  There's a useful quirk about how numbers from natural datasets look that's easy to see.  Hold onto your calculators!  This is going to get a little strange.
...
<BlogImage images={props.pageContext.frontmatter.images} index={17} className="right" alt="Worn pages in a logarith table book." />
...
<BlogImage images={props.pageContext.frontmatter.images} index={19} className="right" alt="Financial figures." />Benford's Law's predictions have powerful applications in financial forensics.  It predicts what financial numbers should 'naturally' look like, and that gives us a way to spot numbers that someone manipulated.  It gives financial auditors a tool to identify general ledger irregularities.<Citation
  data={{
    type: "webpage",
...
<BlogImage images={props.pageContext.frontmatter.images} index={18} className="right" alt="Handwritten financial figures." />Researchers at Columbia University confirmed that if you train a handwriting recognition model using numbers that correspond to Benford's Law's predictions, then the model will perform better at recognizing real-world handwritten financial numbers.
...
/>  In this case, Benford's Law can be a useful tool for detecting manipulated images and preventing the spread of misinformation.
...
Let's take a look at the relationship between the population value and the <mark>number of digits</mark> in the population count, all the way up to 200,000, a six-digit number:

<BlogImage images={props.pageContext.frontmatter.images} index={15} className="full" alt="Linear growth to 200,000." />
<BlogImage images={props.pageContext.frontmatter.images} index={16} className="full" alt="Logarithmic growth in number of digits to 200,000." />
...
<BlogImage images={props.pageContext.frontmatter.images} index={21} className="full" alt="Reproducible Google Collab lab about Benford's Law." />
