...
<BlogImage images={props.pageContext.frontmatter.images} index={20} className="right" alt="The distribution of lead digits in natural numbers according to Benford's Law." />Want to see something weird about numbers?  There's a helpful quirk about how numbers from natural datasets look that's easy to see.  Hold onto your calculators!  This is going to get a little strange.
...
<BlogImage images={props.pageContext.frontmatter.images} index={22} className="full" alt="Linear growth to 20." />
...
<BlogImage images={props.pageContext.frontmatter.images} index={23} className="full" alt="Exponential growth to 20." />
...
<BlogImage images={props.pageContext.frontmatter.images} index={24} className="full" alt="Linear growth to 200." />
<BlogImage images={props.pageContext.frontmatter.images} index={25} className="full" alt="Exponential growth to 200." />
...
<BlogImage images={props.pageContext.frontmatter.images} index={15} className="full" alt="Linear growth to 2,000." />
...
<BlogImage images={props.pageContext.frontmatter.images} index={16} className="full" alt="Logarithmic growth in number of digits to 2,000." />
