...
In the late 1980s and early 1990s, Microsoft's operating systems, wrapped in a mystique of secrecy, stood unchallenged. The company’s 'Fear, Uncertainty, and Doubt' marketing strategy played a crucial role, implying that Windows had exclusive, magical capabilities necessary for computing, casting doubt on other technologies.  The code was closed and secret, they assured us, for our own protection: Hackers couldn't figure out how to hack it if they couldn't see how it worked.  But it was really for their protection, not ours.
