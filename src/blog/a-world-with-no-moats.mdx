...
In the late 1980s and early 1990s, Microsoft's operating systems, wrapped in a mystique of secrecy, stood unchallenged. The company’s 'Fear, Uncertainty, and Doubt' marketing strategy played a crucial role, implying that Windows had exclusive, magical capabilities necessary for computing, casting doubt on alternatives.  Alternatives barely even existed because Microsoft convinced most people that Windows was the only viable option.  The code was closed and secret, they assured us, for our own protection: Hackers couldn't figure out how to hack it if they couldn't see how it worked.  But it was really for their protection, not ours.
...
However, the recent upheaval vaporized this mystique within one bizarre hour. The dramatic leadership changes and board decisions have exposed that their unique governance structure is a liability rather than a strength, introducing instability and unpredictability.
...
For OpenAI customers like Anthus, this situation creates profound uncertainty. The board's willingness to jeopardize the company's future cast doubt on the long-term viability of solutions dependent on the OpenAI API. The realization that OpenAI's mission might supersede the sustainability of its services forces a re-evaluation of our reliance on their technologies.
