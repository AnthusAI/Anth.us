...
<BlogImage images={props.pageContext.frontmatter.images} name="value-over-time.png" className="full" alt="Line chart showing a price-performance index for fixed coding benchmark capability per dollar, climbing from 1x in February 2025 to roughly 10x, and possibly as high as 32x, by August 2026, based on the MIT Price-of-Progress annual rate of price reduction." />
