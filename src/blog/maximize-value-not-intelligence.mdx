...
<BlogImage images={props.pageContext.frontmatter.images} name="value-over-time.png" className="full" alt="Line chart showing a coding-value index climbing from 1x in February 2025 to roughly 10x, and possibly as high as 32x, by August 2026, based on the MIT Price-of-Progress annual rate." />
...
/> Ranked that way, the leaderboard you have been reading is nearly upside down. A few rows from BenchLM as of August 2026:
...
BenchLM says it plainly: value rankings favor cheap models even when absolute performance is modest. A bare Score/$ ranking is a starting point, not a shopping list.
...
<BlogImage
  ...
  className="full"
  alt="A falling all-in cost-per-task curve crossing a band representing the value of a chore getting done, with chores annotated at their crossing points."
/>
