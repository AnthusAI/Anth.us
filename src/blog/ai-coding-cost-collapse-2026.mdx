...
<BlogImage images={props.pageContext.frontmatter.images} name="value-frontier.png" className="full" alt="Bar chart of coding value score (weighted coding score divided by output price per million tokens), rising left to right across GPT-5.6 Sol, GPT-5.6 Terra, Gemini 3.1 Flash-Lite, and GPT-5.6 Luna, with an arrow from Sol to Luna marking Luna at roughly 23 times Sol's coding value per dollar." />
