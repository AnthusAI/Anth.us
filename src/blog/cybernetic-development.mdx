...
Some projects take this philosophy to the extreme: treating Gherkin specifications as the **authoritative source code** and treating implementation code as **generated artifacts**.<Citation
  data={{
    type: "webpage",
    "container-title": "Taskulus",
    title: "Architecture",
    URL: "https://taskul.us/architecture",
    accessed: { "date-parts": [[2026, 2, 10]] },
  }}
/>

[Taskulus](https://taskul.us) is an open-source project management tool built in both Python and Rust. The twist? Both implementations are constrained to pass the exact same Gherkin feature files. The specifications aren't derived from the code—they *define* the code.
...
This is exactly what managers do when coordinating human contractors. They don't pair program with everyone. They use project management systems—Jira, Linear, or repository-based tools like [Taskulus](https://taskul.us) or [Beads](https://github.com/steveyegge/beads).
...
The business world is waking up to this shift too. In February 2026, *Harvard Business Review* identified "Agent Managers" as a critical new role, citing Salesforce leaders who spend their days monitoring agent "scorecards and observability" rather than doing the work themselves.<Citation
  data={{
    type: "webpage",
    "container-title": "Harvard Business Review",
    title: "To Thrive in the AI Era, Companies Need Agent Managers",
    author: "Suraj Srinivasan and Vivienne Wei",
    URL: "https://hbr.org/2026/02/to-thrive-in-the-ai-era-companies-need-agent-managers",
    issued: { "date-parts": [[2026, 2, 12]] },
  }}
/> Whether you call it an Agent Manager or a Cybernetic Developer, the job is the same: you are no longer the operator; you are the architect of the operation.
