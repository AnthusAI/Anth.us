...
{/* VISUAL PROMPT — glass-cockpit.png (PHOTOREAL) ------------------------
    Mood and concept piece, in the register of
    the-simulation-told-them-they-would-win.png: cinematic, desaturated,
    cool-toned, shallow depth of field. Deeper in the body, not a hero.

    The image has to carry the specific idea, not just "airplane": the
    automation is working perfectly and the human has drifted out of the
    loop. Hands OFF the yoke is the whole shot.

    PROMPT:
    Cinematic night interior of a modern airliner glass cockpit, shot from
    behind and between the two seats. Six large flight displays glow softly
    in blue and green, every readout nominal. Both pilots' hands rest in
    their laps, well away from the yokes. No visible faces. Cool desaturated
    palette, deep shadows, shallow depth of field with the instruments sharp
    and the crew falling soft. Quiet, uneventful, faintly uneasy.
    Photorealistic, 35mm, slight film grain. 3:2.

    Alt: "A modern glass cockpit at night, all displays nominal, both
    pilots' hands resting away from the controls."
---------------------------------------------------------------------- */}

<div className="blockDiagram visualPlaceholder">
  <div className="title">photoreal · glass-cockpit.png · 3:2</div>
  <div className="container">
    Night glass cockpit from behind the seats, every display nominal, both pilots'
    hands resting <b>away from the yokes</b>. The automation is working and the human
    has drifted out of the loop — hands-off is the entire shot. Cool, desaturated,
    shallow focus; same register as the war-game piece.
  </div>
</div>
