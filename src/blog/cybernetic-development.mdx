...
{/* VISUAL PROMPT — cybernetic-development.png (HERO POSTER) -------------
    Fourth member of the stencil-poster family (cost collapse = magenta,
    bugonomics = oxblood, maximize value = magenta). This one stays in brand
    magenta #D03382 so it reads as the flagship of the set, not a variant.

    The current file at this path is a 6KB text-on-white placeholder, and it
    is also the preview_image -- it is the social card anywhere this is
    shared. Replacing it is the highest-value visual on the page.

    PROMPT:
    Bold propaganda-poster typography. White stencil spray-paint capital
    letters on a heavily textured deep magenta surface (#D03382), the texture
    reading as painted leather or scuffed concrete. Letters set on a slight
    diagonal, tightly packed, filling the frame edge to edge. High contrast,
    grungy overspray at the letter edges, subtle scuffs, dust, and a soft
    diagonal highlight across the surface. Square format. No imagery other
    than the text. Text reads: "GOVERN, DON'T PROMPT"

    Alt: "Poster: Govern, don't prompt."
---------------------------------------------------------------------- */}

<div className="blockDiagram visualPlaceholder">
  <div className="title">Hero poster · cybernetic-development.png · 2048×2048</div>
  <div className="container">
    Stencil propaganda poster reading <b>“GOVERN, DON'T PROMPT.”</b> Brand magenta,
    same family as the three economics heroes. Replaces the current 6KB
    text-on-white placeholder, which is also the social preview card.
  </div>
</div>
