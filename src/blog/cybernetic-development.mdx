...
*   **Choosing code over clicks:** Using Terraform over AWS Console, migration scripts over phpMyAdmin
*   **Wrapping when necessary:** If you must use a GUI tool, wrap it with infrastructure code that captures its state (e.g., Terraform's `import` to codify existing resources)
...
|---------|---------------|--------------|
| **Infrastructure** | AWS Console | Terraform, CDK, Pulumi |
