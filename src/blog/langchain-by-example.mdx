...
Don't let the articles about AI being the end of software development fool you: It's the *beginning* of a whlle new kind of software development.  But building applications with language models is hard.  Building software is hard enough in the first place before the machines start talking back to you and having opinions.  One tool that's helped us a lot lately is LangChain, and we'd love to share some examples of how useful it can be.
...
As we built more sophisticated applications, the complexity grew. We created systems to manage LLM chat histories, switched to LiteLLM<Citation
  data={{
    type: "webpage",
    "container-title": "Vercel",
    title: "Litellm: A Simple, Intuitive, and Powerful LLM Framework",
    author: "Litellm",
    URL: "https://litellm.vercel.app/",
    issued: { 'date-parts': [[2024, 8, 21]] },
  }}
/> to support various AI APIs, and wrote increasingly complex code to parse LLM responses. Soon, we were spending as much time on infrastructure as on solving our core problems.
