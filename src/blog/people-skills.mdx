...
<BlogImage images={props.pageContext.frontmatter.images} index={1} className="right" alt="Alice, a technical genius with poor people skills." />
...
<BlogImage images={props.pageContext.frontmatter.images} index={0} className="right" alt="Bob, a guy who really knows how to talk with a computer." />
</div>
