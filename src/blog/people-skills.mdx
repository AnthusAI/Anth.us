...
<CustomGatsbyImage index={1} className="right" alt="Alice, a technical genius with poor people skills." />
...
<CustomGatsbyImage index={0} className="right" alt="Bob, a guy who really knows how to talk with a computer." />
</div>
