...
<BlogImage images={props.pageContext.frontmatter.images} index={0} className="right" alt="An AI agent doing stuff for you." />The term "agent" has always referred to another person who does stuff for you. The new term "AI agent" simply refers to an artificial person who does stuff for you.

These AI agents are transforming the business landscape, not just by doing stuff for us, but by making decisions for us autonomously.  It's not really a new concept: Businesses have always had "agents" working on their behalf: from employees to contractors to service providers.  The thing that's new is that now some of the people acting as our agents are artificial.
