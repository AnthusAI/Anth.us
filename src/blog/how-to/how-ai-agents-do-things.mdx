...
<div class="comparisonChart">
  <div class="left-side">
    <h4>Application</h4>
    <div class="item">Manage conversation history</div>
    <div class="item">Execute functions</div>
  </div>
  <div class="separator"></div>
  <div class="right-side">
    <h4>AI Model</h4>
    <div class="item">Generate text</div>
    <div class="item">Decide what tools to use, when and how</div>
  </div>
</div>
