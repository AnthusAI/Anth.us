...
But there's a problem: You check the costs on your evaluation run, and the <mark>GPT 4 tokens are expensive!</mark>  It cost just over $0.40 to do 240 classifications, which means that it would cost... almost 1,700 dollars per million classifications!  Argh!
