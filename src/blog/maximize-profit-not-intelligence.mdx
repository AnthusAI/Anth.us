...
<BlogImage images={props.pageContext.frontmatter.images} name="cost_GPT-4_GPT-3.5.png" className="center" alt="An AI model learning" />

The best part here is that the cost per million will be below your break-even point of $200 per million.  You're profitable!

<BlogImage images={props.pageContext.frontmatter.images} name="profit_per_million_GPT-4_GPT-3.5.png" className="center" alt="An AI model learning" />
...
<BlogImage images={props.pageContext.frontmatter.images} name="precision_recall_GPT-4_GPT-3.5.png" className="center" alt="An AI model learning" />
...
<BlogImage images={props.pageContext.frontmatter.images} name="accuracy_GPT-4_GPT-3.5.png" className="center" alt="An AI model learning" />

Now you have a profitable venture.  But your margins are razor thin:

<BlogImage images={props.pageContext.frontmatter.images} name="profit_GPT-4_GPT-3.5.png" className="center" alt="An AI model learning" />
...
<BlogImage images={props.pageContext.frontmatter.images} name="accuracy_GPT-4_GPT-3.5_Ada_2.png" className="center" alt="An AI model learning" />
...
<BlogImage images={props.pageContext.frontmatter.images} name="cost_GPT-4_GPT-3.5_Ada_2.png" className="center" alt="An AI model learning" />

Wow!  Let's scale that to a million classifications:

<BlogImage images={props.pageContext.frontmatter.images} name="cost_per_million_GPT-4_GPT-3.5_Ada_2.png" className="center" alt="An AI model learning" />

And we know why that's important.  An order-of-magnitude increase in profit:

<BlogImage images={props.pageContext.frontmatter.images} name="profit_per_million_GPT-4_GPT-3.5_Ada_2.png" className="center" alt="An AI model learning" />
...
<BlogImage images={props.pageContext.frontmatter.images} name="time_training_GPT-4_GPT-3.5_Ada_2.png" className="center" alt="An AI model learning" />
...
<BlogImage images={props.pageContext.frontmatter.images} name="accuracy_GPT-4_GPT-3.5_Ada_2_BERT.png" className="center" alt="An AI model learning" />
...
<BlogImage images={props.pageContext.frontmatter.images} name="time_training_GPT-4_GPT-3.5_Ada_2_BERT.png" className="center" alt="An AI model learning" />

### Cost

This classifier completely eliminates the OpenAI bill.

<BlogImage images={props.pageContext.frontmatter.images} name="cost_per_million_GPT-4_GPT-3.5_Ada_2_BERT.png" className="center" alt="An AI model learning" />

### Profit

And that increases profit!

<BlogImage images={props.pageContext.frontmatter.images} name="profit_per_million_GPT-4_GPT-3.5_Ada_2_BERT.png" className="center" alt="An AI model learning" />
...
<BlogImage images={props.pageContext.frontmatter.images} name="time_training_GPT-4_GPT-3.5_Ada_2_BERT_Word2Vec.png" className="center" alt="An AI model learning" />

Does it work, though?

<BlogImage images={props.pageContext.frontmatter.images} name="accuracy_GPT-4_GPT-3.5_Ada_2_BERT_Word2Vec.png" className="center" alt="An AI model learning" />
