...
<BlogImage images={props.pageContext.frontmatter.images} name="Profit for GPT 4 versus GPT 3.5 LLM text classifiers." className="centered" alt="An AI model learning" />
