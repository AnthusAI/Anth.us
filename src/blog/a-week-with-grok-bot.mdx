...
Do not expect it to keep your DevOps rules. Like Grok in its other forms so far, it will do whatever you told it this turn. The standing procedure loses. That may be product. It may be xAI's problem with rules. Score that after a week, with one job where the procedure was written down and it still improvised.
...
And the night-one claim to test: given a written DevOps procedure, did it follow the procedure or the last sentence you typed? If it kept improvising, is that still "smooth," or is it just Grok?
