...
const IndexPage = () => {
  const data = useStaticQuery(graphql`
    query {
      heroImage: file(
        relativePath: { eq: "serverless-ai-software-solutions.png" }
      ) {
        childImageSharp {
      ...
      heroImageWide: file(
        relativePath: { eq: "serverless-ai-software-solutions-wide.png" }
      ) {
        childImageSharp {
          gatsbyImageData(layout: FULL_WIDTH)
        }
      }
      smartProcessAutomation: file(
        relativePath: { eq: "smart-process-automation.png" }
      ) {
        childImageSharp {
          gatsbyImageData(layout: FULL_WIDTH)
        }
  ...
  const links = [
    {
      ...
      image: getImage(
        data.smartProcessAutomation.childImageSharp.gatsbyImageData
      ),
    ...
    },
    {
      ...
      image: getImage(
        data.conversationalAIAgent.childImageSharp.gatsbyImageData
      ),
  ...
  return (
    <Layout>
      ...
      <p className={`${styles.intro} ${styles.textCenter}`}>
        Clients usually arrive asking about one of these.{" "}
