...
<ArticleImage images={props.pageContext.frontmatter.images} name="LangChain/agentic-framework-logos.png" className="full" alt="LangChain is an AI API multiplexer." />
</div>
...
<ArticleImage images={props.pageContext.frontmatter.images} name="API-multiplexer.png" className="full" alt="LangChain is an AI API multiplexer." />
</div>
...
<div className="center-full-image">
<ArticleImage images={props.pageContext.frontmatter.images} name="Two-Models-One-Task.png" className="full" alt="Two models, one task." />
</div>
...
<div className="center-full-image">
<ArticleImage images={props.pageContext.frontmatter.images} name="Safeguard-Retry-Loop.png" className="full" alt="Safeguard retry loop." />
</div>
