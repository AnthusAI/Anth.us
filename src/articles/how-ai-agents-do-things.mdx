...
<ArticleImage images={props.pageContext.frontmatter.images} name="a-cute-kitten.png" className="centered" alt="A cute kitten." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="ai-agent-uses-tools.png" className="right" alt="An AI agent with a collection of tools." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="ai-agent-function-calling-with-no-function.png" className="full" alt="The sequence for request processing for AI agents when there is no function call." />
</div>
...
<div className="center-full-image">
<ArticleImage images={props.pageContext.frontmatter.images} name="ai-agent-function-calling-sequence-diagram.png" className="full" alt="The sequence for function-calling for AI agents." />
</div>
