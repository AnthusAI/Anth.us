...
<ArticleImage images={props.pageContext.frontmatter.images} name="under-pressure.png" className="right" alt="Under pressure!" />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="ephemeral-software-solutions.png" className="right" alt="Each software solution can be a unique snowflake." />
