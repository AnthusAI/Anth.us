...
<ArticleImage images={props.pageContext.frontmatter.images} name="ai-model-that-learns.png" className="right" alt="An AI model learning" />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="ai-agent-RAG-with-no-RAG.png" className="full" alt="The sequence for reqeust processing for AI agents when there is no RAG lookup." />
</div>
...
<div className="center-full-image">
<ArticleImage images={props.pageContext.frontmatter.images} name="ai-agent-RAG-sequence-diagram.png" className="full" alt="The sequence for RAG for AI agents." />
</div>
