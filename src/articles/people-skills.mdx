...
<ArticleImage images={props.pageContext.frontmatter.images} name="alice.png" className="right" alt="Alice, a technical genius with poor people skills." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="bob.png" className="right" alt="Bob, a guy who really knows how to talk with a computer." />
</div>
