...
No problem!  GPT 4's <a href="/articles/how-ai-agents-do-things/">function-calling</a> feature can generate structured responses!  You jump into VS Code and use GPT 4 in GitHub Copilot to craft a text classifier based on GPT 4, and it's 97% accurate when you evaluate it.  <i>AWESOME</i>, it works!
...
<ArticleImage images={props.pageContext.frontmatter.images} name="cost_GPT-4_GPT-3.5.png" className="centered" alt="Cost of GPT 4 vs GPT 3.5 classifiers." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="profit_per_million_GPT-4_GPT-3.5.png" className="centered" alt="Profit per million AI text classifications with GPT 4 versus GPT 3.5." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="precision_recall_GPT-4_GPT-3.5.png" className="centered" alt="Precision and recall for GPT 4 versus GPT 3.5 LLM text classifiers." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="accuracy_GPT-4_GPT-3.5.png" className="centered" alt="Accuracy for GPT 4 versus GPT 3.5 LLM text classifiers." />

Now you have a profitable venture.  But your margins are razor thin:

<ArticleImage images={props.pageContext.frontmatter.images} name="profit_per_million_GPT-4_GPT-3.5.png" className="centered" alt="An AI model learning" />
...
This kind of algorithm that you're selling at a profit is called a "classifier", and there are a lot of ways to make them,<Citation
  data={{
    ...
    URL: "https://levity.ai/articles/text-classifiers-in-machine-learning-a-practical-guide",
...
One way to do it is to use a different model from OpenAI that isn't a generative text model.  It's an embeddings model, for turning text into strings of numbers.<Citation
  data={{
    ...
    URL: "https://openai.com/articles/new-and-improved-embedding-model",
...
<ArticleImage images={props.pageContext.frontmatter.images} name="accuracy_GPT-4_GPT-3.5_Ada_2.png" className="centered" alt="Accuracy across GPT 4, GPT 3.5 and Ada 2 text classifiers." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="cost_GPT-4_GPT-3.5_Ada_2.png" className="centered" alt="Cost across GPT 4, GPT 3.5 and Ada 2 text classifiers." />

Wow!  Let's scale that to a million classifications:

<ArticleImage images={props.pageContext.frontmatter.images} name="cost_per_million_GPT-4_GPT-3.5_Ada_2.png" className="centered" alt="Cost per million across GPT 4, GPT 3.5 and Ada 2 text classifiers." />

And we know why that's important.  An <mark>order-of-magnitude increase in profit</mark>:

<ArticleImage images={props.pageContext.frontmatter.images} name="profit_per_million_GPT-4_GPT-3.5_Ada_2.png" className="centered" alt="Profit across GPT 4, GPT 3.5 and Ada 2 text classifiers." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="time_training_GPT-4_GPT-3.5_Ada_2.png" className="centered" alt="Time breakdown for training and inference across GPT 4, GPT 3.5 and Ada 2 text classifiers." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="accuracy_GPT-4_GPT-3.5_Ada_2_BERT.png" className="centered" alt="Accuracy across GPT 4, GPT 3.5, Ada 2 and BERT text classifiers." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="time_training_GPT-4_GPT-3.5_Ada_2_BERT.png" className="centered" alt="Time for training and inference across GPT 4, GPT 3.5, Ada 2 and BERT text classifiers." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="cost_per_million_GPT-4_GPT-3.5_Ada_2_BERT.png" className="centered" alt="Cost per million classifications across GPT 4, GPT 3.5, Ada 2 and BERT text classifiers." />

### Profit

And that increases our profit!  Our <mark>key performance indicator</mark>!

<ArticleImage images={props.pageContext.frontmatter.images} name="profit_per_million_GPT-4_GPT-3.5_Ada_2_BERT.png" className="centered" alt="Profit across GPT 4, GPT 3.5, Ada 2 and BERT text classifiers." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="time_training_GPT-4_GPT-3.5_Ada_2_BERT_Word2Vec.png" className="centered" alt="Time for training and inference across GPT 4, GPT 3.5, Ada 2, BERT and Word2Vec text classifiers." />

Does it work, though?

<ArticleImage images={props.pageContext.frontmatter.images} name="accuracy_GPT-4_GPT-3.5_Ada_2_BERT_Word2Vec.png" className="centered" alt="Accuracy across GPT 4, GPT 3.5, Ada 2, BERT and Word2Vec text classifiers." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="ROC-curve.png" className="centered" alt="ROC-AUC curve analysis." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="confusion-BERT.png" className="centered" alt="Confusion matrix for BERT." />
