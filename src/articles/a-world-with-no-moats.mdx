...
<ArticleImage images={props.pageContext.frontmatter.images} name="the-revolution-will-be-commodified.png" className="right" alt="THE REVOLUTION WILL BE COMMODIFIED" />
