...
<ArticleImage images={props.pageContext.frontmatter.images} name="border-crossing-counts.png" className="full" alt="The distribution of lead digits from federal border crossing counts." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="connecticut-real-estate-sales.png" className="full" alt="The distribution of lead digits from real estate sale prices." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="new-york-baby-names.png" className="full" alt="The popularity of different baby names." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="nyc_covid19_cases.png" className="full" alt="The distribution of lead digits from NYC daily COVID-19 case counts." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="connecticut-school-attendance.png" className="full" alt="The distribution of lead digits from school attendance counts." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="logarithm-table-book.png" className="right" alt="Worn pages in a logarith table book." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="linear-and-compound-interest-growth-curves.png" className="full" alt="A linear growth rate and a compound-interest growth rate." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="compound_lead_digits.png" className="full" alt="The lead-digit breakdown for a simulated compound interest growth rate." />

But, look at the lead-digit distribution for the bank account balances in the account that grew linearly over time:

<ArticleImage images={props.pageContext.frontmatter.images} name="linear_lead_digits.png" className="full" alt="The lead-digit breakdown for a simulated linear growth rate." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="tyler-easton-faixctm2YRQ-unsplash.png" className="right" alt="Financial figures." />Benford's Law's predictions have powerful applications in financial forensics.  It predicts what financial numbers should 'naturally' look like, giving us a way to spot numbers that someone manipulated.  It gives financial auditors a tool to identify general ledger irregularities.<Citation
  data={{
    type: "webpage",
...
<ArticleImage images={props.pageContext.frontmatter.images} name="simulated-bank-account-deposits---daily-sums.png" className="full" alt="The lead-digit breakdown for the natural transactions scenario." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="simulated-1%-structured-deposits---daily-sums.png" className="full" alt="The lead-digit breakdown for the structured transactions scenario." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="chi-square-statistic-comparison.png" className="full" alt="The Chi-Square Statistic for both scenarios." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="ks-statistic-for-benford's-law.png" className="full" alt="Kolmogorov-Smirnov (KS) Statistic for both scenarios." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="kl-divergence-comparison.png" className="full" alt="Kullback-Leibler (KL) Divergence for both scenarios." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="ciphering-numbers-2961283828065RtvT.jpg" className="right" alt="Handwritten financial figures." />Researchers at Columbia University confirmed that if you train a handwriting recognition model using numbers corresponding to Benford's Law's predictions, the model will perform better at recognizing real-world handwritten financial numbers.
...
<ArticleImage images={props.pageContext.frontmatter.images} name="linear_increase_plot_to_20.png" className="full" alt="Linear growth to 20." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="logarithmic_increase_plot_to_20.png" className="full" alt="Exponential growth to 20." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="linear_increase_plot_200.png" className="full" alt="Linear growth to 200." />
<ArticleImage images={props.pageContext.frontmatter.images} name="logarithmic_increase_plot_200.png" className="full" alt="Exponential growth to 200." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="linear_increase_plot.png" className="full" alt="Linear growth to 2,000." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="logarithmic_increase_plot.png" className="full" alt="Logarithmic growth in number of digits to 2,000." />
...
<ArticleImage images={props.pageContext.frontmatter.images} name="Google-Collab-lab.png" className="full" alt="Reproducible Google Collab lab about Benford's Law." />
